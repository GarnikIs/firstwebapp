...
<%--<head>--%>
    ...
    <%--&lt;%&ndash; START CSS &ndash;%&gt;--%>

    <%--<!-- Bootstrap Core CSS -->--%>
    <%--&lt;%&ndash; Somtimes it is invisible and all css is fucked up &ndash;%&gt;--%>
    ...
    <%--&lt;%&ndash; Language Bar Support CSS &ndash;%&gt;--%>
    <%--<link rel="stylesheet" href="${css}/languageswitcher.css">--%>

    <%--&lt;%&ndash; awesome font icons link &ndash;%&gt;--%>
    <%--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">--%>

    <%--&lt;%&ndash; END CSS &ndash;%&gt;--%>


    <%--&lt;%&ndash; START JS&ndash;%&gt;--%>
    ...
    <%--&lt;%&ndash; Popper in javascript &ndash;%&gt;--%>
    ...
    <%--&lt;%&ndash; Language Bar Support JQuery and JS &ndash;%&gt;--%>
    <%--&lt;%&ndash;<script src="${js}/jquery.min.1.5.0.js"></script>&ndash;%&gt;--%>
    ...
    <%--<!-- NPM  -->--%>
    <%--&lt;%&ndash;<script src="${js}/npm.js"></script>&ndash;%&gt;--%>
...
<%--<body>--%>
    ...
    <%--&lt;%&ndash;<%@include file="flows_navbar.jsp" %>&ndash;%&gt;--%>
